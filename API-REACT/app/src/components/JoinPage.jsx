...
const JoinPage = ({ handlePage }) => {
    ...
    const uploadImage = async (imageFile) => {
        ...
        //폼바디에 넣어서 요청하기, contenttype 기본이 폼데이터라 적지 않는다.
        const res = await fetch(reqUrl, {
            method: 'POST',
            body: form,
        });
        ...
        <>
            ...
            <section>
                ...
                <div>
                    ...
                    <input type="text" id="userIntroInput" name="intro" placeholder="자신과 판매할 상품에 대해 소개해 주세요." value={intro} onChange={inputIntro} />
                </div>
